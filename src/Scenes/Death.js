class Death extends Phaser.Scene {
    ...
    create(){
        ...
        const gameover = this.add.bitmapText(85, 200, "rocketSquare", "You didn't make it back home...", 50);
        const restart = this.add.bitmapText(85, 450, "rocketSquare", "Press SPACE to retry your journey", 25);
